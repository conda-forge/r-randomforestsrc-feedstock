...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-randomforestsrc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-randomforestsrc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-randomforestsrc
# for installing globally
pixi global install r-randomforestsrc
```
...
It is possible to list all of the versions of `r-randomforestsrc` available on your platform:
...
```
pixi search r-randomforestsrc --channel conda-forge
```
